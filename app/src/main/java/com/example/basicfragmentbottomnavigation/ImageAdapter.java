    ...
    public void onBindViewHolder(final ImageViewHolder holder, int position) {
        ...
        holder.bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse(uploadCurrent.getLink());
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
       ...
       // public TextView textViewBranch;
        ...
        public ImageViewHolder(View itemView) {
            super(itemView);
            textViewDesc = itemView.findViewById(R.id.tv_expand);
            textViewRank = itemView.findViewById(R.id.tv_name2);
            textViewLoc = itemView.findViewById(R.id.tv_name1);
